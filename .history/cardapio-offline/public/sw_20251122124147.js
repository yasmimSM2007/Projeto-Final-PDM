...
// Usamos a versão CDN do Workbox via importScripts (forma compatível sem bundler)
...
if (workbox) {
  ...
  // ===== PRECACHE =====
  // Garanta que os caminhos aqui existam no build/preview/public
  workbox.precaching.precacheAndRoute([
    ...
    // NOTA: assets (css/js) normalmente possuem hash no build e são atendidos pelas rotas abaixo
  ]);
